...
const struct Tileset gTileset_H_Primary =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_H_Primary,
    .palettes = gTilesetPalettes_H_Primary,
    .metatiles = gMetatiles_H_Primary,
    .metatileAttributes = gMetatileAttributes_H_Primary,
    .callback = NULL,
};

const struct Tileset gTileset_H_Lumberton =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_H_Lumberton,
    .palettes = gTilesetPalettes_H_Lumberton,
    .metatiles = gMetatiles_H_Lumberton,
    .metatileAttributes = gMetatileAttributes_H_Lumberton,
    .callback = NULL,
};
