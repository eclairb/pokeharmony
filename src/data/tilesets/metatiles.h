...
const u16 gMetatiles_H_Primary[] = INCBIN_U16("data/tilesets/primary/h_primary/metatiles.bin");
const u16 gMetatileAttributes_H_Primary[] = INCBIN_U16("data/tilesets/primary/h_primary/metatile_attributes.bin");

const u16 gMetatiles_H_Lumberton[] = INCBIN_U16("data/tilesets/secondary/h_lumberton/metatiles.bin");
const u16 gMetatileAttributes_H_Lumberton[] = INCBIN_U16("data/tilesets/secondary/h_lumberton/metatile_attributes.bin");
